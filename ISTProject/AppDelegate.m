...
@interface AppDelegate ()<LoginSuccess>
...
{
    //登录视图
    LubeCRMLoginViewController * loginVC=[[LubeCRMLoginViewController alloc]initWithNibName:@"LubeCRMLoginViewController" bundle:nil];
